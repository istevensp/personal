...
export const strings = {
  en: {
    ...
    'common.all': 'All',
    'teaching.introPrefix': 'Current and historical courses taught at',
    'teaching.introSuffix': ', with links to official SAAC student evaluation reports.',
  ...
  es: {
    ...
    'common.all': 'Todos',
    'teaching.introPrefix': 'Cursos actuales e históricos dictados en',
    'teaching.introSuffix': ', con enlaces a los reportes oficiales de evaluación estudiantil del SAAC.',
